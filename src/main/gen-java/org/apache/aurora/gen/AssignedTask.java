...
public class AssignedTask implements org.apache.thrift.TBase<AssignedTask, AssignedTask._Fields>, java.io.Serializable, Cloneable, Comparable<AssignedTask> {
  ...
  private String slaveId; // required
  private String slaveHost; // required
  private TaskConfig task; // required
  private Map<String,Integer> assignedPorts; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_assignedPorts);
    if (present_assignedPorts)
      builder.append(assignedPorts);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignedPorts = new HashMap<String,Integer>(2*_map92.size);
                for (int _i93 = 0; _i93 < _map92.size; ++_i93)
                {
                  ...
                  struct.assignedPorts.put(_key94, _val95);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AssignedTask struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignedPorts != null) {
        oprot.writeFieldBegin(ASSIGNED_PORTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter96 : struct.assignedPorts.entrySet())
          {
  ...
  private static class AssignedTaskTupleScheme extends TupleScheme<AssignedTask> {
      ...
      if (struct.isSetAssignedPorts()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter97 : struct.assignedPorts.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, AssignedTask struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map98 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.assignedPorts = new HashMap<String,Integer>(2*_map98.size);
          for (int _i99 = 0; _i99 < _map98.size; ++_i99)
          {
            ...
            struct.assignedPorts.put(_key100, _val101);
          }
        }
        struct.setAssignedPortsIsSet(true);
      }

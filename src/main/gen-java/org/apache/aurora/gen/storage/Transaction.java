...
public class Transaction implements org.apache.thrift.TBase<Transaction, Transaction._Fields>, java.io.Serializable, Cloneable, Comparable<Transaction> {
  ...
  private List<Op> ops; // required
  private int schemaVersion; // required
  ...
  public Transaction(Transaction other) {
    ...
    if (other.isSetOps()) {
      List<Op> __this__ops = new ArrayList<Op>(other.ops.size());
      for (Op other_element : other.ops) {
        __this__ops.add(new Op(other_element));
      }
  ...
  public java.util.Iterator<Op> getOpsIterator() {
    return (this.ops == null) ? null : this.ops.iterator();
  }

  public void addToOps(Op elem) {
    if (this.ops == null) {
  ...
  public Transaction setOps(List<Op> ops) {
    this.ops = ops;
    return this;
  }
  ...
  public Transaction setSchemaVersion(int schemaVersion) {
    this.schemaVersion = schemaVersion;
    setSchemaVersionIsSet(true);
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ops = new ArrayList<Op>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  Op _elem18;
                  _elem18 = new Op();
                  _elem18.read(iprot);
                  struct.ops.add(_elem18);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ops = new ArrayList<Op>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            Op _elem23;
            _elem23 = new Op();
            _elem23.read(iprot);
            struct.ops.add(_elem23);
          }
        }
        struct.setOpsIsSet(true);
      }

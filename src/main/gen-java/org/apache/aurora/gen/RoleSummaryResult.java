...
public class RoleSummaryResult implements org.apache.thrift.TBase<RoleSummaryResult, RoleSummaryResult._Fields>, java.io.Serializable, Cloneable, Comparable<RoleSummaryResult> {
  ...
  private Set<RoleSummary> summaries; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_summaries);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.summaries = new HashSet<RoleSummary>(2*_set270.size);
                for (int _i271 = 0; _i271 < _set270.size; ++_i271)
                {
                  RoleSummary _elem272;
                  _elem272 = new RoleSummary();
                  _elem272.read(iprot);
                  struct.summaries.add(_elem272);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RoleSummaryResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.summaries != null) {
        oprot.writeFieldBegin(SUMMARIES_FIELD_DESC);
        {
          ...
          for (RoleSummary _iter273 : struct.summaries)
          {
      ...
      if (struct.isSetSummaries()) {
        {
          ...
          for (RoleSummary _iter274 : struct.summaries)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.summaries = new HashSet<RoleSummary>(2*_set275.size);
          for (int _i276 = 0; _i276 < _set275.size; ++_i276)
          {
            RoleSummary _elem277;
            _elem277 = new RoleSummary();
            _elem277.read(iprot);
            struct.summaries.add(_elem277);
          }
        }
        struct.setSummariesIsSet(true);
      }

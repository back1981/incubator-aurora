...
public class RewriteConfigsRequest implements org.apache.thrift.TBase<RewriteConfigsRequest, RewriteConfigsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RewriteConfigsRequest> {
  ...
  private List<ConfigRewrite> rewriteCommands; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_rewriteCommands);
    if (present_rewriteCommands)
      builder.append(rewriteCommands);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rewriteCommands = new ArrayList<ConfigRewrite>(_list318.size);
                for (int _i319 = 0; _i319 < _list318.size; ++_i319)
                {
                  ConfigRewrite _elem320;
                  _elem320 = new ConfigRewrite();
                  _elem320.read(iprot);
                  struct.rewriteCommands.add(_elem320);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RewriteConfigsRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.rewriteCommands != null) {
        oprot.writeFieldBegin(REWRITE_COMMANDS_FIELD_DESC);
        {
          ...
          for (ConfigRewrite _iter321 : struct.rewriteCommands)
          {
      ...
      if (struct.isSetRewriteCommands()) {
        {
          ...
          for (ConfigRewrite _iter322 : struct.rewriteCommands)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.rewriteCommands = new ArrayList<ConfigRewrite>(_list323.size);
          for (int _i324 = 0; _i324 < _list323.size; ++_i324)
          {
            ConfigRewrite _elem325;
            _elem325 = new ConfigRewrite();
            _elem325.read(iprot);
            struct.rewriteCommands.add(_elem325);
          }
        }
        struct.setRewriteCommandsIsSet(true);
      }

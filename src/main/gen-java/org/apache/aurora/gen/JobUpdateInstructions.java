...
public class JobUpdateInstructions implements org.apache.thrift.TBase<JobUpdateInstructions, JobUpdateInstructions._Fields>, java.io.Serializable, Cloneable, Comparable<JobUpdateInstructions> {
  ...
  private Set<InstanceTaskConfig> initialState; // required
  private InstanceTaskConfig desiredState; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.initialState = new HashSet<InstanceTaskConfig>(2*_set190.size);
                for (int _i191 = 0; _i191 < _set190.size; ++_i191)
                {
                  InstanceTaskConfig _elem192;
                  _elem192 = new InstanceTaskConfig();
                  _elem192.read(iprot);
                  struct.initialState.add(_elem192);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobUpdateInstructions struct) throws org.apache.thrift.TException {
      ...
      if (struct.initialState != null) {
        oprot.writeFieldBegin(INITIAL_STATE_FIELD_DESC);
        {
          ...
          for (InstanceTaskConfig _iter193 : struct.initialState)
          {
      ...
      if (struct.isSetInitialState()) {
        {
          ...
          for (InstanceTaskConfig _iter194 : struct.initialState)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.initialState = new HashSet<InstanceTaskConfig>(2*_set195.size);
          for (int _i196 = 0; _i196 < _set195.size; ++_i196)
          {
            InstanceTaskConfig _elem197;
            _elem197 = new InstanceTaskConfig();
            _elem197.read(iprot);
            struct.initialState.add(_elem197);
          }
        }
        struct.setInitialStateIsSet(true);
      }

...
public class JobUpdateState implements org.apache.thrift.TBase<JobUpdateState, JobUpdateState._Fields>, java.io.Serializable, Cloneable, Comparable<JobUpdateState> {
  ...
  private long createdTimestampMs; // required
  private long lastModifiedTimestampMs; // required
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case CREATED_TIMESTAMP_MS:
      return Long.valueOf(getCreatedTimestampMs());

    case LAST_MODIFIED_TIMESTAMP_MS:
      return Long.valueOf(getLastModifiedTimestampMs());
  ...
  public int hashCode() {
    ...
    builder.append(present_createdTimestampMs);
    if (present_createdTimestampMs)
      builder.append(createdTimestampMs);

    boolean present_lastModifiedTimestampMs = true;
    builder.append(present_lastModifiedTimestampMs);
    if (present_lastModifiedTimestampMs)
      builder.append(lastModifiedTimestampMs);

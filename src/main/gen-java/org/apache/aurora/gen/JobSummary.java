...
public class JobSummary implements org.apache.thrift.TBase<JobSummary, JobSummary._Fields>, java.io.Serializable, Cloneable, Comparable<JobSummary> {
  ...
  private JobConfiguration job; // required
  private JobStats stats; // required
  private long nextCronRunMs; // optional
  ...
  private _Fields optionals[] = {_Fields.NEXT_CRON_RUN_MS};
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case NEXT_CRON_RUN_MS:
      return Long.valueOf(getNextCronRunMs());
  ...
  public int hashCode() {
    ...
    builder.append(present_nextCronRunMs);
    if (present_nextCronRunMs)
      builder.append(nextCronRunMs);

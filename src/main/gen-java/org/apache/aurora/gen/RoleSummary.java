...
public class RoleSummary implements org.apache.thrift.TBase<RoleSummary, RoleSummary._Fields>, java.io.Serializable, Cloneable, Comparable<RoleSummary> {
  ...
  private int jobCount; // required
  private int cronJobCount; // required
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case JOB_COUNT:
      return Integer.valueOf(getJobCount());

    case CRON_JOB_COUNT:
      return Integer.valueOf(getCronJobCount());
  ...
  public int hashCode() {
    ...
    builder.append(present_jobCount);
    if (present_jobCount)
      builder.append(jobCount);

    boolean present_cronJobCount = true;
    builder.append(present_cronJobCount);
    if (present_cronJobCount)
      builder.append(cronJobCount);

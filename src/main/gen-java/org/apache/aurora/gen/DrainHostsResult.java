            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.statuses = new HashSet<HostStatus>(2*_set238.size);
                for (int _i239 = 0; _i239 < _set238.size; ++_i239)
                {
                  HostStatus _elem240;
                  _elem240 = new HostStatus();
                  _elem240.read(iprot);
                  struct.statuses.add(_elem240);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DrainHostsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.statuses != null) {
        oprot.writeFieldBegin(STATUSES_FIELD_DESC);
        {
          ...
          for (HostStatus _iter241 : struct.statuses)
          {
      ...
      if (struct.isSetStatuses()) {
        {
          ...
          for (HostStatus _iter242 : struct.statuses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.statuses = new HashSet<HostStatus>(2*_set243.size);
          for (int _i244 = 0; _i244 < _set243.size; ++_i244)
          {
            HostStatus _elem245;
            _elem245 = new HostStatus();
            _elem245.read(iprot);
            struct.statuses.add(_elem245);
          }
        }
        struct.setStatusesIsSet(true);
      }

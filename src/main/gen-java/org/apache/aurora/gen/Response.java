...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  private ResponseCode responseCode; // required
  private ServerInfo serverInfo; // required
  private Result result; // optional
  private List<ResponseDetail> details; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_serverInfo);
        ...
        switch (schemeField.id) {
          case 1: // RESPONSE_CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.responseCode = ResponseCode.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.details = new ArrayList<ResponseDetail>(_list310.size);
                for (int _i311 = 0; _i311 < _list310.size; ++_i311)
                {
                  ResponseDetail _elem312;
                  _elem312 = new ResponseDetail();
                  _elem312.read(iprot);
                  struct.details.add(_elem312);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Response struct) throws org.apache.thrift.TException {
      ...
      if (struct.details != null) {
        oprot.writeFieldBegin(DETAILS_FIELD_DESC);
        {
          ...
          for (ResponseDetail _iter313 : struct.details)
          {
      ...
      if (struct.isSetDetails()) {
        {
          ...
          for (ResponseDetail _iter314 : struct.details)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.details = new ArrayList<ResponseDetail>(_list315.size);
          for (int _i316 = 0; _i316 < _list315.size; ++_i316)
          {
            ResponseDetail _elem317;
            _elem317 = new ResponseDetail();
            _elem317.read(iprot);
            struct.details.add(_elem317);
          }
        }
        struct.setDetailsIsSet(true);
      }

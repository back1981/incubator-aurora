...
public class InstanceTaskConfig implements org.apache.thrift.TBase<InstanceTaskConfig, InstanceTaskConfig._Fields>, java.io.Serializable, Cloneable, Comparable<InstanceTaskConfig> {
  ...
  private Set<Range> instances; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.instances = new HashSet<Range>(2*_set182.size);
                for (int _i183 = 0; _i183 < _set182.size; ++_i183)
                {
                  Range _elem184;
                  _elem184 = new Range();
                  _elem184.read(iprot);
                  struct.instances.add(_elem184);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InstanceTaskConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.instances != null) {
        oprot.writeFieldBegin(INSTANCES_FIELD_DESC);
        {
          ...
          for (Range _iter185 : struct.instances)
          {
      ...
      if (struct.isSetInstances()) {
        {
          ...
          for (Range _iter186 : struct.instances)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.instances = new HashSet<Range>(2*_set187.size);
          for (int _i188 = 0; _i188 < _set187.size; ++_i188)
          {
            Range _elem189;
            _elem189 = new Range();
            _elem189.read(iprot);
            struct.instances.add(_elem189);
          }
        }
        struct.setInstancesIsSet(true);
      }

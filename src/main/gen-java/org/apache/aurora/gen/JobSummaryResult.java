...
public class JobSummaryResult implements org.apache.thrift.TBase<JobSummaryResult, JobSummaryResult._Fields>, java.io.Serializable, Cloneable, Comparable<JobSummaryResult> {
  ...
  private Set<JobSummary> summaries; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.summaries = new HashSet<JobSummary>(2*_set278.size);
                for (int _i279 = 0; _i279 < _set278.size; ++_i279)
                {
                  JobSummary _elem280;
                  _elem280 = new JobSummary();
                  _elem280.read(iprot);
                  struct.summaries.add(_elem280);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobSummaryResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.summaries != null) {
        oprot.writeFieldBegin(SUMMARIES_FIELD_DESC);
        {
          ...
          for (JobSummary _iter281 : struct.summaries)
          {
      ...
      if (struct.isSetSummaries()) {
        {
          ...
          for (JobSummary _iter282 : struct.summaries)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.summaries = new HashSet<JobSummary>(2*_set283.size);
          for (int _i284 = 0; _i284 < _set283.size; ++_i284)
          {
            JobSummary _elem285;
            _elem285 = new JobSummary();
            _elem285.read(iprot);
            struct.summaries.add(_elem285);
          }
        }
        struct.setSummariesIsSet(true);
      }

...
public class GetPendingReasonResult implements org.apache.thrift.TBase<GetPendingReasonResult, GetPendingReasonResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetPendingReasonResult> {
  ...
  private Set<PendingReason> reasons; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_reasons);
    if (present_reasons)
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.reasons = new HashSet<PendingReason>(2*_set294.size);
                for (int _i295 = 0; _i295 < _set294.size; ++_i295)
                {
                  PendingReason _elem296;
                  _elem296 = new PendingReason();
                  _elem296.read(iprot);
                  struct.reasons.add(_elem296);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPendingReasonResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.reasons != null) {
        oprot.writeFieldBegin(REASONS_FIELD_DESC);
        {
          ...
          for (PendingReason _iter297 : struct.reasons)
          {
      ...
      if (struct.isSetReasons()) {
        {
          ...
          for (PendingReason _iter298 : struct.reasons)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.reasons = new HashSet<PendingReason>(2*_set299.size);
          for (int _i300 = 0; _i300 < _set299.size; ++_i300)
          {
            PendingReason _elem301;
            _elem301 = new PendingReason();
            _elem301.read(iprot);
            struct.reasons.add(_elem301);
          }
        }
        struct.setReasonsIsSet(true);
      }

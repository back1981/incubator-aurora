...
public class Hosts implements org.apache.thrift.TBase<Hosts, Hosts._Fields>, java.io.Serializable, Cloneable, Comparable<Hosts> {
  ...
  public int hashCode() {
    ...
    builder.append(present_hostNames);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.hostNames = new HashSet<String>(2*_set166.size);
                for (int _i167 = 0; _i167 < _set166.size; ++_i167)
                {
                  String _elem168;
                  _elem168 = iprot.readString();
                  struct.hostNames.add(_elem168);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Hosts struct) throws org.apache.thrift.TException {
      ...
      if (struct.hostNames != null) {
        oprot.writeFieldBegin(HOST_NAMES_FIELD_DESC);
        {
          ...
          for (String _iter169 : struct.hostNames)
          {
      ...
      if (struct.isSetHostNames()) {
        {
          ...
          for (String _iter170 : struct.hostNames)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hostNames = new HashSet<String>(2*_set171.size);
          for (int _i172 = 0; _i172 < _set171.size; ++_i172)
          {
            String _elem173;
            _elem173 = iprot.readString();
            struct.hostNames.add(_elem173);
          }
        }
        struct.setHostNamesIsSet(true);
      }

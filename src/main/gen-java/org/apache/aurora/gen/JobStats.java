...
public class JobStats implements org.apache.thrift.TBase<JobStats, JobStats._Fields>, java.io.Serializable, Cloneable, Comparable<JobStats> {
  ...
  private int activeTaskCount; // required
  private int finishedTaskCount; // required
  private int failedTaskCount; // required
  private int pendingTaskCount; // required

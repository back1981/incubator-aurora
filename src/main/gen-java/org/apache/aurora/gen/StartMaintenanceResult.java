            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.statuses = new HashSet<HostStatus>(2*_set230.size);
                for (int _i231 = 0; _i231 < _set230.size; ++_i231)
                {
                  HostStatus _elem232;
                  _elem232 = new HostStatus();
                  _elem232.read(iprot);
                  struct.statuses.add(_elem232);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StartMaintenanceResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.statuses != null) {
        oprot.writeFieldBegin(STATUSES_FIELD_DESC);
        {
          ...
          for (HostStatus _iter233 : struct.statuses)
          {
      ...
      if (struct.isSetStatuses()) {
        {
          ...
          for (HostStatus _iter234 : struct.statuses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.statuses = new HashSet<HostStatus>(2*_set235.size);
          for (int _i236 = 0; _i236 < _set235.size; ++_i236)
          {
            HostStatus _elem237;
            _elem237 = new HostStatus();
            _elem237.read(iprot);
            struct.statuses.add(_elem237);
          }
        }
        struct.setStatusesIsSet(true);
      }

...
public class Result extends org.apache.thrift.TUnion<Result, Result._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField GET_VERSION_RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("getVersionResult", org.apache.thrift.protocol.TType.STRUCT, (short)15);
  private static final org.apache.thrift.protocol.TField ACQUIRE_LOCK_RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("acquireLockResult", org.apache.thrift.protocol.TType.STRUCT, (short)16);
  ...
  private static final org.apache.thrift.protocol.TField GET_LOCKS_RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("getLocksResult", org.apache.thrift.protocol.TType.STRUCT, (short)19);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    GET_VERSION_RESULT((short)15, "getVersionResult"),
    ACQUIRE_LOCK_RESULT((short)16, "acquireLockResult"),
    ROLE_SUMMARY_RESULT((short)17, "roleSummaryResult"),
    JOB_SUMMARY_RESULT((short)18, "jobSummaryResult"),
    GET_LOCKS_RESULT((short)19, "getLocksResult"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 15: // GET_VERSION_RESULT
          return GET_VERSION_RESULT;
        case 16: // ACQUIRE_LOCK_RESULT
  ...
  static {
    ...
    tmpMap.put(_Fields.GET_VERSION_RESULT, new org.apache.thrift.meta_data.FieldMetaData("getVersionResult", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, APIVersion.class)));
    tmpMap.put(_Fields.ACQUIRE_LOCK_RESULT, new org.apache.thrift.meta_data.FieldMetaData("acquireLockResult", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, AcquireLockResult.class)));
    ...
    tmpMap.put(_Fields.GET_LOCKS_RESULT, new org.apache.thrift.meta_data.FieldMetaData("getLocksResult", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GetLocksResult.class)));
  ...
  public static Result getVersionResult(APIVersion value) {
    Result x = new Result();
    x.setGetVersionResult(value);
    return x;
  }

  public static Result acquireLockResult(AcquireLockResult value) {
    Result x = new Result();
    x.setAcquireLockResult(value);
    return x;
  }
  ...
  public static Result getLocksResult(GetLocksResult value) {
    Result x = new Result();
    x.setGetLocksResult(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case GET_VERSION_RESULT:
        if (value instanceof APIVersion) {
          break;
        }
        throw new ClassCastException("Was expecting value of type APIVersion for field 'getVersionResult', but got " + value.getClass().getSimpleName());
      case ACQUIRE_LOCK_RESULT:
        if (value instanceof AcquireLockResult) {
          break;
        }
        throw new ClassCastException("Was expecting value of type AcquireLockResult for field 'acquireLockResult', but got " + value.getClass().getSimpleName());
      ...
      case GET_LOCKS_RESULT:
        if (value instanceof GetLocksResult) {
          break;
        }
        throw new ClassCastException("Was expecting value of type GetLocksResult for field 'getLocksResult', but got " + value.getClass().getSimpleName());
  ...
  protected Object standardSchemeReadValue(org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TField field) throws org.apache.thrift.TException {
    ...
    if (setField != null) {
      switch (setField) {
        ...
        case GET_VERSION_RESULT:
          if (field.type == GET_VERSION_RESULT_FIELD_DESC.type) {
            APIVersion getVersionResult;
            getVersionResult = new APIVersion();
            getVersionResult.read(iprot);
        ...
        case ACQUIRE_LOCK_RESULT:
          if (field.type == ACQUIRE_LOCK_RESULT_FIELD_DESC.type) {
            AcquireLockResult acquireLockResult;
            acquireLockResult = new AcquireLockResult();
            acquireLockResult.read(iprot);
        ...
        case GET_LOCKS_RESULT:
          if (field.type == GET_LOCKS_RESULT_FIELD_DESC.type) {
            GetLocksResult getLocksResult;
            getLocksResult = new GetLocksResult();
            getLocksResult.read(iprot);
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case END_MAINTENANCE_RESULT:
        ...
        return;
      case GET_VERSION_RESULT:
        APIVersion getVersionResult = (APIVersion)value_;
        getVersionResult.write(oprot);
        return;
      case ACQUIRE_LOCK_RESULT:
        AcquireLockResult acquireLockResult = (AcquireLockResult)value_;
        acquireLockResult.write(oprot);
        return;
      case ROLE_SUMMARY_RESULT:
      ...
      case JOB_SUMMARY_RESULT:
        ...
        return;
      case GET_LOCKS_RESULT:
        GetLocksResult getLocksResult = (GetLocksResult)value_;
        getLocksResult.write(oprot);
        return;
      case CONFIG_SUMMARY_RESULT:
  ...
  public APIVersion getGetVersionResult() {
    if (getSetField() == _Fields.GET_VERSION_RESULT) {
      ...
      throw new RuntimeException("Cannot get field 'getVersionResult' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setGetVersionResult(APIVersion value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.GET_VERSION_RESULT;
    value_ = value;
  }
  ...
  public AcquireLockResult getAcquireLockResult() {
    if (getSetField() == _Fields.ACQUIRE_LOCK_RESULT) {
      ...
      throw new RuntimeException("Cannot get field 'acquireLockResult' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setAcquireLockResult(AcquireLockResult value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.ACQUIRE_LOCK_RESULT;
    value_ = value;
  }
  ...
  public GetLocksResult getGetLocksResult() {
    if (getSetField() == _Fields.GET_LOCKS_RESULT) {
      ...
      throw new RuntimeException("Cannot get field 'getLocksResult' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setGetLocksResult(GetLocksResult value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.GET_LOCKS_RESULT;
    value_ = value;
  }
  ...
  public boolean isSetGetVersionResult() {
    return setField_ == _Fields.GET_VERSION_RESULT;
  }


  public boolean isSetAcquireLockResult() {
    return setField_ == _Fields.ACQUIRE_LOCK_RESULT;
  }
  ...
  public boolean isSetGetLocksResult() {
    return setField_ == _Fields.GET_LOCKS_RESULT;
  }

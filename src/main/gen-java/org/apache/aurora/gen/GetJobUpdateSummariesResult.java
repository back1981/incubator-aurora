...
public class GetJobUpdateSummariesResult implements org.apache.thrift.TBase<GetJobUpdateSummariesResult, GetJobUpdateSummariesResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetJobUpdateSummariesResult> {
  ...
  private List<JobUpdateSummary> updateSummaries; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_updateSummaries);
    if (present_updateSummaries)
      builder.append(updateSummaries);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updateSummaries = new ArrayList<JobUpdateSummary>(_list302.size);
                for (int _i303 = 0; _i303 < _list302.size; ++_i303)
                {
                  JobUpdateSummary _elem304;
                  _elem304 = new JobUpdateSummary();
                  _elem304.read(iprot);
                  struct.updateSummaries.add(_elem304);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetJobUpdateSummariesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateSummaries != null) {
        oprot.writeFieldBegin(UPDATE_SUMMARIES_FIELD_DESC);
        {
          ...
          for (JobUpdateSummary _iter305 : struct.updateSummaries)
          {
      ...
      if (struct.isSetUpdateSummaries()) {
        {
          ...
          for (JobUpdateSummary _iter306 : struct.updateSummaries)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.updateSummaries = new ArrayList<JobUpdateSummary>(_list307.size);
          for (int _i308 = 0; _i308 < _list307.size; ++_i308)
          {
            JobUpdateSummary _elem309;
            _elem309 = new JobUpdateSummary();
            _elem309.read(iprot);
            struct.updateSummaries.add(_elem309);
          }
        }
        struct.setUpdateSummariesIsSet(true);
      }

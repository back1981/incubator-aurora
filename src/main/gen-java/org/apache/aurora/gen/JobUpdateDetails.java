...
public class JobUpdateDetails implements org.apache.thrift.TBase<JobUpdateDetails, JobUpdateDetails._Fields>, java.io.Serializable, Cloneable, Comparable<JobUpdateDetails> {
  ...
  private JobUpdate update; // required
  private List<JobUpdateEvent> updateEvents; // required
  private List<JobInstanceUpdateEvent> instanceEvents; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updateEvents = new ArrayList<JobUpdateEvent>(_list198.size);
                for (int _i199 = 0; _i199 < _list198.size; ++_i199)
                {
                  JobUpdateEvent _elem200;
                  _elem200 = new JobUpdateEvent();
                  _elem200.read(iprot);
                  struct.updateEvents.add(_elem200);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instanceEvents = new ArrayList<JobInstanceUpdateEvent>(_list201.size);
                for (int _i202 = 0; _i202 < _list201.size; ++_i202)
                {
                  JobInstanceUpdateEvent _elem203;
                  _elem203 = new JobInstanceUpdateEvent();
                  _elem203.read(iprot);
                  struct.instanceEvents.add(_elem203);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobUpdateDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateEvents != null) {
        oprot.writeFieldBegin(UPDATE_EVENTS_FIELD_DESC);
        {
          ...
          for (JobUpdateEvent _iter204 : struct.updateEvents)
          {
      ...
      if (struct.instanceEvents != null) {
        oprot.writeFieldBegin(INSTANCE_EVENTS_FIELD_DESC);
        {
          ...
          for (JobInstanceUpdateEvent _iter205 : struct.instanceEvents)
          {
      ...
      if (struct.isSetUpdateEvents()) {
        {
          ...
          for (JobUpdateEvent _iter206 : struct.updateEvents)
          {
      ...
      if (struct.isSetInstanceEvents()) {
        {
          ...
          for (JobInstanceUpdateEvent _iter207 : struct.instanceEvents)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.updateEvents = new ArrayList<JobUpdateEvent>(_list208.size);
          for (int _i209 = 0; _i209 < _list208.size; ++_i209)
          {
            JobUpdateEvent _elem210;
            _elem210 = new JobUpdateEvent();
            _elem210.read(iprot);
            struct.updateEvents.add(_elem210);
          }
        }
        struct.setUpdateEventsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.instanceEvents = new ArrayList<JobInstanceUpdateEvent>(_list211.size);
          for (int _i212 = 0; _i212 < _list211.size; ++_i212)
          {
            JobInstanceUpdateEvent _elem213;
            _elem213 = new JobInstanceUpdateEvent();
            _elem213.read(iprot);
            struct.instanceEvents.add(_elem213);
          }
        }
        struct.setInstanceEventsIsSet(true);
      }

...
public class JobUpdateSettings implements org.apache.thrift.TBase<JobUpdateSettings, JobUpdateSettings._Fields>, java.io.Serializable, Cloneable, Comparable<JobUpdateSettings> {
  ...
  private static final org.apache.thrift.protocol.TField MAX_WAIT_TO_INSTANCE_RUNNING_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("maxWaitToInstanceRunningMs", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  private int updateGroupSize; // required
  private int maxPerInstanceFailures; // required
  private int maxFailedInstances; // required
  private int maxWaitToInstanceRunningMs; // required
  private int minWaitInInstanceRunningMs; // required
  private boolean rollbackOnFailure; // required
  private Set<Range> updateOnlyTheseInstances; // required
  private boolean waitForBatchCompletion; // required
  private int blockIfNoPulsesAfterMs; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     */
    MAX_WAIT_TO_INSTANCE_RUNNING_MS((short)4, "maxWaitToInstanceRunningMs"),
    /**
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // MAX_WAIT_TO_INSTANCE_RUNNING_MS
  ...
  static {
    ...
    tmpMap.put(_Fields.MAX_FAILED_INSTANCES, new org.apache.thrift.meta_data.FieldMetaData("maxFailedInstances", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.MAX_WAIT_TO_INSTANCE_RUNNING_MS, new org.apache.thrift.meta_data.FieldMetaData("maxWaitToInstanceRunningMs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    tmpMap.put(_Fields.WAIT_FOR_BATCH_COMPLETION, new org.apache.thrift.meta_data.FieldMetaData("waitForBatchCompletion", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.BLOCK_IF_NO_PULSES_AFTER_MS, new org.apache.thrift.meta_data.FieldMetaData("blockIfNoPulsesAfterMs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    int blockIfNoPulsesAfterMs)
  {
    ...
    this.maxWaitToInstanceRunningMs = maxWaitToInstanceRunningMs;
  ...
  public JobUpdateSettings(JobUpdateSettings other) {
    ...
    this.maxWaitToInstanceRunningMs = other.maxWaitToInstanceRunningMs;
  ...
  public void clear() {
    ...
    this.maxWaitToInstanceRunningMs = 0;
   ...
   * Max time to wait until an instance reaches RUNNING state.
   */
  public JobUpdateSettings setMaxWaitToInstanceRunningMs(int maxWaitToInstanceRunningMs) {
    this.maxWaitToInstanceRunningMs = maxWaitToInstanceRunningMs;
    setMaxWaitToInstanceRunningMsIsSet(true);
    return this;
  }
  ...
  public void unsetMaxWaitToInstanceRunningMs() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __MAXWAITTOINSTANCERUNNINGMS_ISSET_ID);
  }

  /** Returns true if field maxWaitToInstanceRunningMs is set (has been assigned a value) and false otherwise */
  public boolean isSetMaxWaitToInstanceRunningMs() {
    return EncodingUtils.testBit(__isset_bitfield, __MAXWAITTOINSTANCERUNNINGMS_ISSET_ID);
  }

  public void setMaxWaitToInstanceRunningMsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __MAXWAITTOINSTANCERUNNINGMS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MAX_WAIT_TO_INSTANCE_RUNNING_MS:
      if (value == null) {
        unsetMaxWaitToInstanceRunningMs();
      } else {
        setMaxWaitToInstanceRunningMs((Integer)value);
      }
      break;
  ...
  public boolean equals(JobUpdateSettings that) {
    ...
    boolean this_present_maxWaitToInstanceRunningMs = true;
    boolean that_present_maxWaitToInstanceRunningMs = true;
    if (this_present_maxWaitToInstanceRunningMs || that_present_maxWaitToInstanceRunningMs) {
      if (!(this_present_maxWaitToInstanceRunningMs && that_present_maxWaitToInstanceRunningMs))
        return false;
      if (this.maxWaitToInstanceRunningMs != that.maxWaitToInstanceRunningMs)
        return false;
    }
  ...
  public int hashCode() {
    ...
    builder.append(present_updateGroupSize);
    if (present_updateGroupSize)
      builder.append(updateGroupSize);

    boolean present_maxPerInstanceFailures = true;
    builder.append(present_maxPerInstanceFailures);
    if (present_maxPerInstanceFailures)
      builder.append(maxPerInstanceFailures);

    boolean present_maxFailedInstances = true;
    builder.append(present_maxFailedInstances);
    if (present_maxFailedInstances)
      builder.append(maxFailedInstances);

    boolean present_maxWaitToInstanceRunningMs = true;
    builder.append(present_maxWaitToInstanceRunningMs);
    if (present_maxWaitToInstanceRunningMs)
      builder.append(maxWaitToInstanceRunningMs);

    boolean present_minWaitInInstanceRunningMs = true;
    builder.append(present_minWaitInInstanceRunningMs);
    if (present_minWaitInInstanceRunningMs)
      builder.append(minWaitInInstanceRunningMs);

    boolean present_rollbackOnFailure = true;
    builder.append(present_rollbackOnFailure);
    if (present_rollbackOnFailure)
      builder.append(rollbackOnFailure);

    boolean present_updateOnlyTheseInstances = true && (isSetUpdateOnlyTheseInstances());
    builder.append(present_updateOnlyTheseInstances);
    if (present_updateOnlyTheseInstances)
      builder.append(updateOnlyTheseInstances);

    boolean present_waitForBatchCompletion = true;
    builder.append(present_waitForBatchCompletion);
    if (present_waitForBatchCompletion)
      builder.append(waitForBatchCompletion);

    boolean present_blockIfNoPulsesAfterMs = true;
    builder.append(present_blockIfNoPulsesAfterMs);
    if (present_blockIfNoPulsesAfterMs)
      builder.append(blockIfNoPulsesAfterMs);
  ...
  public int compareTo(JobUpdateSettings other) {
    ...
    lastComparison = Boolean.valueOf(isSetMaxWaitToInstanceRunningMs()).compareTo(other.isSetMaxWaitToInstanceRunningMs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMaxWaitToInstanceRunningMs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.maxWaitToInstanceRunningMs, other.maxWaitToInstanceRunningMs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class JobUpdateSettingsStandardScheme extends StandardScheme<JobUpdateSettings> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, JobUpdateSettings struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // MAX_WAIT_TO_INSTANCE_RUNNING_MS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.maxWaitToInstanceRunningMs = iprot.readI32();
              struct.setMaxWaitToInstanceRunningMsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.updateOnlyTheseInstances = new HashSet<Range>(2*_set174.size);
                for (int _i175 = 0; _i175 < _set174.size; ++_i175)
                {
                  Range _elem176;
                  _elem176 = new Range();
                  _elem176.read(iprot);
                  struct.updateOnlyTheseInstances.add(_elem176);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobUpdateSettings struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(MAX_WAIT_TO_INSTANCE_RUNNING_MS_FIELD_DESC);
      oprot.writeI32(struct.maxWaitToInstanceRunningMs);
      oprot.writeFieldEnd();
      ...
      if (struct.updateOnlyTheseInstances != null) {
        oprot.writeFieldBegin(UPDATE_ONLY_THESE_INSTANCES_FIELD_DESC);
        {
          ...
          for (Range _iter177 : struct.updateOnlyTheseInstances)
          {
  ...
  private static class JobUpdateSettingsTupleScheme extends TupleScheme<JobUpdateSettings> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, JobUpdateSettings struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMaxWaitToInstanceRunningMs()) {
        optionals.set(3);
      }
      ...
      if (struct.isSetUpdateOnlyTheseInstances()) {
        {
          ...
          for (Range _iter178 : struct.updateOnlyTheseInstances)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.updateOnlyTheseInstances = new HashSet<Range>(2*_set179.size);
          for (int _i180 = 0; _i180 < _set179.size; ++_i180)
          {
            Range _elem181;
            _elem181 = new Range();
            _elem181.read(iprot);
            struct.updateOnlyTheseInstances.add(_elem181);
          }
        }
        struct.setUpdateOnlyTheseInstancesIsSet(true);
      }

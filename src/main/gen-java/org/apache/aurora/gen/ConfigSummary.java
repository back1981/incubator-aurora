...
public class ConfigSummary implements org.apache.thrift.TBase<ConfigSummary, ConfigSummary._Fields>, java.io.Serializable, Cloneable, Comparable<ConfigSummary> {
  ...
  private Set<ConfigGroup> groups; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.groups = new HashSet<ConfigGroup>(2*_set76.size);
                for (int _i77 = 0; _i77 < _set76.size; ++_i77)
                {
                  ConfigGroup _elem78;
                  _elem78 = new ConfigGroup();
                  _elem78.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ConfigSummary struct) throws org.apache.thrift.TException {
      ...
      if (struct.groups != null) {
        oprot.writeFieldBegin(GROUPS_FIELD_DESC);
        {
          ...
          for (ConfigGroup _iter79 : struct.groups)
          {
            _iter79.write(oprot);
          }
          oprot.writeSetEnd();
      ...
      if (struct.isSetGroups()) {
        {
          ...
          for (ConfigGroup _iter80 : struct.groups)
          {
            _iter80.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.groups = new HashSet<ConfigGroup>(2*_set81.size);
          for (int _i82 = 0; _i82 < _set81.size; ++_i82)
          {
            ConfigGroup _elem83;
            _elem83 = new ConfigGroup();
            _elem83.read(iprot);

...
public class ListBackupsResult implements org.apache.thrift.TBase<ListBackupsResult, ListBackupsResult._Fields>, java.io.Serializable, Cloneable, Comparable<ListBackupsResult> {
  ...
  private Set<String> backups; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_backups);
    if (present_backups)
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.backups = new HashSet<String>(2*_set222.size);
                for (int _i223 = 0; _i223 < _set222.size; ++_i223)
                {
                  String _elem224;
                  _elem224 = iprot.readString();
                  struct.backups.add(_elem224);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListBackupsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.backups != null) {
        oprot.writeFieldBegin(BACKUPS_FIELD_DESC);
        {
          ...
          for (String _iter225 : struct.backups)
          {
      ...
      if (struct.isSetBackups()) {
        {
          ...
          for (String _iter226 : struct.backups)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.backups = new HashSet<String>(2*_set227.size);
          for (int _i228 = 0; _i228 < _set227.size; ++_i228)
          {
            String _elem229;
            _elem229 = iprot.readString();
            struct.backups.add(_elem229);
          }
        }
        struct.setBackupsIsSet(true);
      }

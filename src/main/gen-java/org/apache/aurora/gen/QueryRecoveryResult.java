...
public class QueryRecoveryResult implements org.apache.thrift.TBase<QueryRecoveryResult, QueryRecoveryResult._Fields>, java.io.Serializable, Cloneable, Comparable<QueryRecoveryResult> {
  ...
  private Set<ScheduledTask> tasks; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.tasks = new HashSet<ScheduledTask>(2*_set246.size);
                for (int _i247 = 0; _i247 < _set246.size; ++_i247)
                {
                  ScheduledTask _elem248;
                  _elem248 = new ScheduledTask();
                  _elem248.read(iprot);
                  struct.tasks.add(_elem248);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryRecoveryResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.tasks != null) {
        oprot.writeFieldBegin(TASKS_FIELD_DESC);
        {
          ...
          for (ScheduledTask _iter249 : struct.tasks)
          {
      ...
      if (struct.isSetTasks()) {
        {
          ...
          for (ScheduledTask _iter250 : struct.tasks)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tasks = new HashSet<ScheduledTask>(2*_set251.size);
          for (int _i252 = 0; _i252 < _set251.size; ++_i252)
          {
            ScheduledTask _elem253;
            _elem253 = new ScheduledTask();
            _elem253.read(iprot);
            struct.tasks.add(_elem253);
          }
        }
        struct.setTasksIsSet(true);
      }

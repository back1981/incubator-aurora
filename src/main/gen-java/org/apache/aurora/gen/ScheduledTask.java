...
public class ScheduledTask implements org.apache.thrift.TBase<ScheduledTask, ScheduledTask._Fields>, java.io.Serializable, Cloneable, Comparable<ScheduledTask> {
  ...
  private AssignedTask assignedTask; // required
  private ScheduleStatus status; // required
  private int failureCount; // required
  private List<TaskEvent> taskEvents; // required
  private String ancestorId; // required
  ...
  public int hashCode() {
    ...
    builder.append(present_assignedTask);
    if (present_assignedTask)
      builder.append(assignedTask);
    ...
    builder.append(present_taskEvents);
    if (present_taskEvents)
      builder.append(taskEvents);

    boolean present_ancestorId = true && (isSetAncestorId());
    builder.append(present_ancestorId);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taskEvents = new ArrayList<TaskEvent>(_list102.size);
                for (int _i103 = 0; _i103 < _list102.size; ++_i103)
                {
                  TaskEvent _elem104;
                  _elem104 = new TaskEvent();
                  _elem104.read(iprot);
                  struct.taskEvents.add(_elem104);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScheduledTask struct) throws org.apache.thrift.TException {
      ...
      if (struct.taskEvents != null) {
        oprot.writeFieldBegin(TASK_EVENTS_FIELD_DESC);
        {
          ...
          for (TaskEvent _iter105 : struct.taskEvents)
          {
      ...
      if (struct.isSetTaskEvents()) {
        {
          ...
          for (TaskEvent _iter106 : struct.taskEvents)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.taskEvents = new ArrayList<TaskEvent>(_list107.size);
          for (int _i108 = 0; _i108 < _list107.size; ++_i108)
          {
            TaskEvent _elem109;
            _elem109 = new TaskEvent();
            _elem109.read(iprot);
            struct.taskEvents.add(_elem109);
          }
        }
        struct.setTaskEventsIsSet(true);
      }
